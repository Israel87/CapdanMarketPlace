    ...
    public partial class CheckoutController : BasePublicController
    {
      ...
      //  private readonly ICustomer
        ...
        public CheckoutController(ICheckoutModelFactory checkoutModelFactory,
            ...
            // Added customerAttributeService Service.
            ...
            CustomerSettings customerSettings)
        {
            ...
            // added the customerAttributeService
        ...
        public virtual IActionResult OpcConfirmOrder()
        {
            try
            {
                ...
                if (placeOrderResult.Success)
                {
                    //passing values to a model and then save in a session.
                    var paymentgatewaymodel = new Models.Order.PaymentGatewayDetailsModel(){

                            CustomerID = placeOrderResult.PlacedOrder.CustomerId,
                            OrderGUID = placeOrderResult.PlacedOrder.OrderGuid.ToString(),
                            FirstName = placeOrderResult.PlacedOrder.BillingAddress.FirstName,
                            LastName = placeOrderResult.PlacedOrder.BillingAddress.LastName,
                            Amount = placeOrderResult.PlacedOrder.OrderTotal,
                            Description = "Receipt for: " + placeOrderResult.PlacedOrder.BillingAddress.FirstName
                            + ", " + placeOrderResult.PlacedOrder.BillingAddress.LastName,
                            Email = placeOrderResult.PlacedOrder.BillingAddress.Email,
                            Status = placeOrderResult.PlacedOrder.PaymentStatus,
                            PhoneNumber = placeOrderResult.PlacedOrder.Customer.BillingAddress.PhoneNumber
                            
                    };
                   
                    HttpContext.Session.Set<Models.Order.PaymentGatewayDetailsModel>("paymentgatewayDetails", paymentgatewaymodel);
               

                    //placeOrderResult.PlacedOrder.Or
                    HttpContext.Session.Set<ProcessPaymentRequest>("OrderPaymentInfo", null);
                    var postProcessPaymentRequest = new PostProcessPaymentRequest
                    {
                        Order = placeOrderResult.PlacedOrder
                    ...
                    if (paymentMethod.PaymentMethodType == PaymentMethodType.Standard)
                    {
                        ...
                        return Json(new
                        {
                            ...
                            redirect = $"{_webHelper.GetStoreLocation()}checkout/ChamsSwitchInterface"
                        });
                    }
        ...
        // action to redirect to the payment gateway view.
        public virtual IActionResult ChamsSwitchInterface()
        {
            var getPaymentDetails = HttpContext.Session.Get<Models.Order.PaymentGatewayDetailsModel>("paymentgatewayDetails");
