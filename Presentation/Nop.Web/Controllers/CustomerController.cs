                    ...
                    case CustomerLoginResults.Successful:
                        {
                            ...
                            {
                                var rolename = customer.CustomerRoles.Select(e => e.Name).ToArray();
                                if (rolename.Contains("Merchant"))
                                {
                                    ViewBag.Pagetitle = "Merchant Admin";
            ...
            if (ModelState.IsValid)
            {
                ...
                if (registrationResult.Success)
                {
                    ...
                    var defaultAddress = new Address
                    {
                        ...
                        //PhoneNumber = customer.GetAttribute<string>(SystemCustomerAttributeNames.PhoneNumber),
