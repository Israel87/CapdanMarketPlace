...
namespace Nop.Web.Validators.Customer
{
    public partial class RegisterValidator : BaseNopValidator<RegisterModel>
    {
            ...
            CustomerSettings customerSettings)
        {
            ...
            //RuleFor(x => x.PhoneNumber).NotEmpty().WithMessage(localizationService.GetResource("Phone Number is Required"));
            ...
            if (customerSettings.PhoneNumberRequired && customerSettings.PhoneNumberEnabled)
            {
                //RuleFor(x => x.PhoneNumber).NotEmpty().WithMessage(localizationService.GetResource("Account.Fields.PhoneNumber.Required"));
            }
        }
    }
}