...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class ProductController : BaseAdminController
    {
        ...
        public virtual IActionResult List()
        {
            ...
            //{
            //    //a vendor should have access only to his products
            //    IsLoggedInAsMerchant = _workContext.CurrentCustomer != null,
            //    AllowVendorsToImportProducts = _vendorSettings.AllowVendorsToImportProducts
            //};
        ...
        public virtual IActionResult ProductList(DataSourceRequest command, ProductListModel model)
        {
            ...
            var products = _productService.SearchProducts(
                ...
                customerId: _workContext.CurrentCustomer.CustomerRoles.Any(p => p.Name == "Administrators") ? 0 : _workContext.CurrentCustomer.Id
            );          
        ...
        public virtual IActionResult Edit(int id)
        {
            ...
            //a merchant should have access only to his product
            if (_workContext.CurrentCustomer != null && product.CustomerId != _workContext.CurrentCustomer.Id)
                return RedirectToAction("List");
        ...
        public virtual IActionResult Edit(ProductModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //{
                //    model.ShowOnHomePage = product.ShowOnHomePage;2
                //}

                //vendors cannot edit "Show on home page" property
                if (_workContext.CurrentCustomer != null && model.ShowOnHomePage != product.ShowOnHomePage)
                {
