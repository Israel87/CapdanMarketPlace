...
namespace Nop.Web.Areas.Admin.Models.Customers
{
    ...
    public partial class CustomerModel : BaseNopEntityModel
    {
        ...
        public bool BVNEnabled { get; set; }
        [NopResourceDisplayName("BVN")]
        public string BVN { get; set; }

        public bool CIVNEnabled { get; set; }
        [NopResourceDisplayName("CIVN")]
        public string CIVN { get; set; }

        public bool SubDomainEnabled { get; set; }
        [NopResourceDisplayName("Store SubDomain")]
        public string SubDomain { get; set; }

        public bool StoreAddressEnabled { get; set; }
        [NopResourceDisplayName("Store Address")]
        public string StoreAddress { get; set; }

        public bool StoreDescriptionEnabled { get; set; }
        [NopResourceDisplayName("Store Description")]
