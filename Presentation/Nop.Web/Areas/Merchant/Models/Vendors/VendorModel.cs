...
namespace Nop.Web.Areas.Merchant.Models.Vendors
{
    ...
    public partial class VendorModel : BaseNopEntityModel, ILocalizedModel<VendorLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Merchant.Vendors.Fields.Name")]
        public string Name { get; set; }

        [DataType(DataType.EmailAddress)]
        [NopResourceDisplayName("Merchant.Vendors.Fields.Email")]
        public string Email { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.Description")]
        public string Description { get; set; }

        [UIHint("Picture")]
        [NopResourceDisplayName("Merchant.Vendors.Fields.Picture")]
        public int PictureId { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.MerchantComment")]
        public string MerchantComment { get; set; }

        public AddressModel Address { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.Active")]
        public bool Active { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.DisplayOrder")]
        public int DisplayOrder { get; set; }
        

        [NopResourceDisplayName("Merchant.Vendors.Fields.MetaKeywords")]
        public string MetaKeywords { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.MetaDescription")]
        public string MetaDescription { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.MetaTitle")]
        public string MetaTitle { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.SeName")]
        public string SeName { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.PageSize")]
        public int PageSize { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.AllowCustomersToSelectPageSize")]
        public bool AllowCustomersToSelectPageSize { get; set; }

        [NopResourceDisplayName("Merchant.Vendors.Fields.PageSizeOptions")]
        ...
        [NopResourceDisplayName("Merchant.Vendors.Fields.AssociatedCustomerEmails")]
        public IList<AssociatedCustomerInfo> AssociatedCustomers { get; set; }

        //vendor notes
        [NopResourceDisplayName("Merchant.Vendors.VendorNotes.Fields.Note")]
        ...
        public partial class VendorNote : BaseNopEntityModel
        {
            ...
            [NopResourceDisplayName("Merchant.Vendors.VendorNotes.Fields.CreatedOn")]
