...
namespace Nop.Web.Areas.Merchant.Models.Settings
{
    ...
    public partial class ReturnRequestActionModel : BaseNopEntityModel, ILocalizedModel<ReturnRequestActionLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Order.ReturnRequestActions.Name")]
        public string Name { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Order.ReturnRequestActions.DisplayOrder")]
