...
namespace Nop.Web.Areas.Merchant.Models.Settings
{
    public partial class ShippingSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.ShipToSameAddress")]
        public bool ShipToSameAddress { get; set; }
        public bool ShipToSameAddress_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.AllowPickUpInStore")]
        public bool AllowPickUpInStore { get; set; }
        public bool AllowPickUpInStore_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.DisplayPickupPointsOnMap")]
        public bool DisplayPickupPointsOnMap { get; set; }
        public bool DisplayPickupPointsOnMap_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.GoogleMapsApiKey")]
        public string GoogleMapsApiKey { get; set; }
        public bool GoogleMapsApiKey_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.UseWarehouseLocation")]
        public bool UseWarehouseLocation { get; set; }
        public bool UseWarehouseLocation_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.NotifyCustomerAboutShippingFromMultipleLocations")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.FreeShippingOverXEnabled")]
        public bool FreeShippingOverXEnabled { get; set; }
        public bool FreeShippingOverXEnabled_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.FreeShippingOverXValue")]
        public decimal FreeShippingOverXValue { get; set; }
        public bool FreeShippingOverXValue_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.FreeShippingOverXIncludingTax")]
        public bool FreeShippingOverXIncludingTax { get; set; }
        public bool FreeShippingOverXIncludingTax_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.EstimateShippingEnabled")]
        public bool EstimateShippingEnabled { get; set; }
        public bool EstimateShippingEnabled_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.DisplayShipmentEventsToCustomers")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.DisplayShipmentEventsToStoreOwner")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.HideShippingTotal")]
        public bool HideShippingTotal { get; set; }
        public bool HideShippingTotal_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.BypassShippingMethodSelectionIfOnlyOne")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Shipping.ConsiderAssociatedProductsDimensions")]
