...
namespace Nop.Web.Areas.Merchant.Models.Settings
{
    public partial class TaxSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.PricesIncludeTax")]
        public bool PricesIncludeTax { get; set; }
        public bool PricesIncludeTax_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.AllowCustomersToSelectTaxDisplayType")]
        public bool AllowCustomersToSelectTaxDisplayType { get; set; }
        public bool AllowCustomersToSelectTaxDisplayType_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.TaxDisplayType")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.DisplayTaxSuffix")]
        public bool DisplayTaxSuffix { get; set; }
        public bool DisplayTaxSuffix_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.DisplayTaxRates")]
        public bool DisplayTaxRates { get; set; }
        public bool DisplayTaxRates_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.HideZeroTax")]
        public bool HideZeroTax { get; set; }
        public bool HideZeroTax_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.HideTaxInOrderSummary")]
        public bool HideTaxInOrderSummary { get; set; }
        public bool HideTaxInOrderSummary_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.ForceTaxExclusionFromOrderSubtotal")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.DefaultTaxCategory")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.TaxBasedOn")]
        public int TaxBasedOn { get; set; }
        public bool TaxBasedOn_OverrideForStore { get; set; }
        public SelectList TaxBasedOnValues { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.TaxBasedOnPickupPointAddress")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.ShippingIsTaxable")]
        public bool ShippingIsTaxable { get; set; }
        public bool ShippingIsTaxable_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.ShippingPriceIncludesTax")]
        public bool ShippingPriceIncludesTax { get; set; }
        public bool ShippingPriceIncludesTax_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.ShippingTaxClass")]
        public int ShippingTaxClassId { get; set; }
        public bool ShippingTaxClassId_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.PaymentMethodAdditionalFeeIsTaxable")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.PaymentMethodAdditionalFeeIncludesTax")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.PaymentMethodAdditionalFeeTaxClass")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.EuVatEnabled")]
        public bool EuVatEnabled { get; set; }
        public bool EuVatEnabled_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.EuVatShopCountry")]
        ...
        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.EuVatAllowVatExemption")]
        public bool EuVatAllowVatExemption { get; set; }
        public bool EuVatAllowVatExemption_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.EuVatUseWebService")]
        public bool EuVatUseWebService { get; set; }
        public bool EuVatUseWebService_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.EuVatAssumeValid")]
        public bool EuVatAssumeValid { get; set; }
        public bool EuVatAssumeValid_OverrideForStore { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Settings.Tax.EuVatEmailMerchantWhenNewVatSubmitted")]
        public bool EuVatEmailMerchantWhenNewVatSubmitted { get; set; }
        public bool EuVatEmailMerchantWhenNewVatSubmitted_OverrideForStore { get; set; }
    }
}