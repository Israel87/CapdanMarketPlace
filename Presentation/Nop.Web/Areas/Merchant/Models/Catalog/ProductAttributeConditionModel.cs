...
namespace Nop.Web.Areas.Merchant.Models.Catalog
{
    public partial class ProductAttributeConditionModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Merchant.Catalog.Products.ProductAttributes.Attributes.Condition.EnableCondition")]
        public bool EnableCondition { get; set; }

        [NopResourceDisplayName("Merchant.Catalog.Products.ProductAttributes.Attributes.Condition.Attributes")]
