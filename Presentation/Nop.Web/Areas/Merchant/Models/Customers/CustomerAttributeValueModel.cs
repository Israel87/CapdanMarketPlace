...
namespace Nop.Web.Areas.Merchant.Models.Customers
{
    ...
    public partial class CustomerAttributeValueModel : BaseNopEntityModel, ILocalizedModel<CustomerAttributeValueLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Merchant.Customers.CustomerAttributes.Values.Fields.Name")]
        public string Name { get; set; }

        [NopResourceDisplayName("Merchant.Customers.CustomerAttributes.Values.Fields.IsPreSelected")]
        public bool IsPreSelected { get; set; }

        [NopResourceDisplayName("Merchant.Customers.CustomerAttributes.Values.Fields.DisplayOrder")]
