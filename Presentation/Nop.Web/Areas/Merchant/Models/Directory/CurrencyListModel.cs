...
namespace Nop.Web.Areas.Merchant.Models.Directory
{
    public partial class CurrencyListModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Merchant.Configuration.Currencies.Fields.CurrencyRateAutoUpdateEnabled")]
        public bool AutoUpdateEnabled { get; set; }
        
        public IList<ExchangeRateModel> ExchangeRates { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Currencies.Fields.ExchangeRateProvider")]
