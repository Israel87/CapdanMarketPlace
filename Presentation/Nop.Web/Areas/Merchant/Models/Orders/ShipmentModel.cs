...
namespace Nop.Web.Areas.Merchant.Models.Orders
{
    public partial class ShipmentModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Merchant.Orders.Shipments.ID")]
        public override int Id { get; set; }
        public int OrderId { get; set; }
        [NopResourceDisplayName("Merchant.Orders.Shipments.CustomOrderNumber")]
        public string CustomOrderNumber { get; set; }
        [NopResourceDisplayName("Merchant.Orders.Shipments.TotalWeight")]
        public string TotalWeight { get; set; }
        [NopResourceDisplayName("Merchant.Orders.Shipments.TrackingNumber")]
        public string TrackingNumber { get; set; }
        public string TrackingNumberUrl { get; set; }

        [NopResourceDisplayName("Merchant.Orders.Shipments.ShippedDate")]
        public string ShippedDate { get; set; }
        public bool CanShip { get; set; }
        public DateTime? ShippedDateUtc { get; set; }

        [NopResourceDisplayName("Merchant.Orders.Shipments.DeliveryDate")]
        public string DeliveryDate { get; set; }
        public bool CanDeliver { get; set; }
        public DateTime? DeliveryDateUtc { get; set; }

        [NopResourceDisplayName("Merchant.Orders.Shipments.MerchantComment")]
        ...
        public partial class ShipmentItemModel : BaseNopEntityModel
        {
            ...
            [NopResourceDisplayName("Merchant.Orders.Shipments.Products.ProductName")]
            ...
            [NopResourceDisplayName("Merchant.Orders.Shipments.Products.ItemWeight")]
            public string ItemWeight { get; set; }
            [NopResourceDisplayName("Merchant.Orders.Shipments.Products.ItemDimensions")]
            public string ItemDimensions { get; set; }

            public int QuantityToAdd { get; set; }
            public int QuantityOrdered { get; set; }
            [NopResourceDisplayName("Merchant.Orders.Shipments.Products.QtyShipped")]
