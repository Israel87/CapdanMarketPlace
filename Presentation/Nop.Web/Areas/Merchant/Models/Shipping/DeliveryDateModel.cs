...
namespace Nop.Web.Areas.Merchant.Models.Shipping
{
    ...
    public partial class DeliveryDateModel : BaseNopEntityModel, ILocalizedModel<DeliveryDateLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Merchant.Configuration.Shipping.DeliveryDates.Fields.Name")]
        public string Name { get; set; }

        [NopResourceDisplayName("Merchant.Configuration.Shipping.DeliveryDates.Fields.DisplayOrder")]
