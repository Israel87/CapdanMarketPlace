...
using Nop.Web.Areas.Merchant.Models.ExternalAuthentication;
using Nop.Web.Areas.Merchant.Models.Forums;
using Nop.Web.Areas.Merchant.Models.Localization;
using Nop.Web.Areas.Merchant.Models.Logging;
...
using Nop.Web.Areas.Merchant.Models.Payments;
...
using Nop.Web.Areas.Merchant.Models.Topics;
...
namespace Nop.Web.Areas.Merchant.Infrastructure.Mapper
{
    /// <summary>
    /// AutoMapper configuration for Merchant area models
    /// </summary>
    public class MerchantMapperConfiguration : Profile, IMapperProfile
    {
        public MerchantMapperConfiguration()
        {
            ...
            CreateMap<TaxSettings, TaxSettingsModel>()
                ...
                .ForMember(dest => dest.EuVatEmailMerchantWhenNewVatSubmitted_OverrideForStore, mo => mo.Ignore())
                .ForMember(dest => dest.CustomProperties, mo => mo.Ignore())
                .ForMember(dest => dest.Form, mo => mo.Ignore());
            ...
            CreateMap<OrderSettings, OrderSettingsModel>()
                ...
                .ForMember(dest => dest.AllowMerchantsToBuyCallForPriceProducts_OverrideForStore, mo => mo.Ignore())
                .ForMember(dest => dest.CustomProperties, mo => mo.Ignore())
                .ForMember(dest => dest.Form, mo => mo.Ignore());
