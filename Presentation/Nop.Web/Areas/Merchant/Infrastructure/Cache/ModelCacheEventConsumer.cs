...
namespace Nop.Web.Areas.Merchant.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Vendor>>
    {
        ...
        /// </summary>
        public const string OFFICIAL_NEWS_MODEL_KEY = "Nop.pres.Merchant.official.news";
        public const string OFFICIAL_NEWS_PATTERN_KEY = "Nop.pres.Merchant.official.news";
        
        /// <summary>
        /// Key for specification attributes caching (product details page)
        /// </summary>
        public const string SPEC_ATTRIBUTES_MODEL_KEY = "Nop.pres.Merchant.product.specs";
        public const string SPEC_ATTRIBUTES_PATTERN_KEY = "Nop.pres.Merchant.product.specs";
        ...
        /// </remarks>
        public const string CATEGORIES_LIST_KEY = "Nop.pres.Merchant.categories.list-{0}";
        public const string CATEGORIES_LIST_PATTERN_KEY = "Nop.pres.Merchant.categories.list";
        ...
        /// {0} : show hidden records?
        /// </remarks>
        public const string MANUFACTURERS_LIST_KEY = "Nop.pres.Merchant.manufacturers.list-{0}";
        public const string MANUFACTURERS_LIST_PATTERN_KEY = "Nop.pres.Merchant.manufacturers.list";
        ...
        /// {0} : show hidden records?
        /// </remarks>
        public const string VENDORS_LIST_KEY = "Nop.pres.Merchant.vendors.list-{0}";
        public const string VENDORS_LIST_PATTERN_KEY = "Nop.pres.Merchant.vendors.list";
        ...
        public void HandleEvent(EntityUpdatedEvent<Setting> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(OFFICIAL_NEWS_PATTERN_KEY); //depends on MerchantAreaSettings.HideAdvertisementsOnMerchantArea
        }
