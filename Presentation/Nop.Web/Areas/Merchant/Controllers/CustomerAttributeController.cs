...
{
    public partial class CustomerAttributeController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Create(CustomerAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Customers.CustomerAttributes.Added"));
        ...
        public virtual IActionResult Edit(CustomerAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Customers.CustomerAttributes.Updated"));
                if (continueEditing)
                {
                    //selected tab
                    SaveSelectedTabName();
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Customers.CustomerAttributes.Deleted"));
            return RedirectToAction("List");
        }
