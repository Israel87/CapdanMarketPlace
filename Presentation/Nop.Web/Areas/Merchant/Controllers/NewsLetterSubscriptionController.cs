...
{
	public partial class NewsLetterSubscriptionController : BaseMerchantController
	{
	    #region Fields
		...
		public virtual IActionResult List()
        {
            ...
            {
                Value = "0",
                Text = _localizationService.GetResource("Merchant.Promotions.NewsLetterSubscriptions.List.SearchActive.All")
            });
            model.ActiveList.Add(new SelectListItem
            {
                Value = "1",
                Text = _localizationService.GetResource("Merchant.Promotions.NewsLetterSubscriptions.List.SearchActive.ActiveOnly")
            });
            model.ActiveList.Add(new SelectListItem
            {
                Value = "2",
                Text = _localizationService.GetResource("Merchant.Promotions.NewsLetterSubscriptions.List.SearchActive.NotActiveOnly")
            });
        ...
        public virtual IActionResult ImportCsv(IFormFile importcsvfile)
        {
            ...
            try
            {
                if (importcsvfile != null && importcsvfile.Length > 0)
                {
                    ...
                    SuccessNotification(string.Format(_localizationService.GetResource("Merchant.Promotions.NewsLetterSubscriptions.ImportEmailsSuccess"), count));
                    return RedirectToAction("List");
                }
