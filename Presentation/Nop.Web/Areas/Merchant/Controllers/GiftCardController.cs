...
{
    public partial class GiftCardController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult List()
        {
            ...
            {
                Value = "0",
                Text = _localizationService.GetResource("Merchant.GiftCards.List.Activated.All")
            });
            model.ActivatedList.Add(new SelectListItem
            {
                Value = "1",
                Text = _localizationService.GetResource("Merchant.GiftCards.List.Activated.ActivatedOnly")
            });
            model.ActivatedList.Add(new SelectListItem
            {
                Value = "2",
                Text = _localizationService.GetResource("Merchant.GiftCards.List.Activated.DeactivatedOnly")
            });
            return View(model);
        }
        ...
        public virtual IActionResult Create(GiftCardModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.GiftCards.Added"));
        ...
        public virtual IActionResult Edit(GiftCardModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.GiftCards.Updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.GiftCards.Deleted"));
            return RedirectToAction("List");
        }
