...
{
    public partial class PaymentController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult MethodRestrictionsSave(IFormCollection form)
        {
            ...
            SuccessNotification(
                _localizationService.GetResource("Merchant.Configuration.Payment.MethodRestrictions.Updated"));
