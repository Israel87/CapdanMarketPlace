...
using Nop.Web.Areas.Merchant.Models.Home;
using Nop.Core;
...
{
    public partial class HomeController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Index()
        {
            ...
            if (_permissionService.Authorize(StandardPermissionProvider.ManageMaintenance))
            {
                ...
                if (errors.Any())
                    WarningNotification(_localizationService.GetResource("Merchant.System.Warnings.Errors"), false);
            }
