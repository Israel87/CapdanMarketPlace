...
using Nop.Web.Areas.Merchant.Models.Forums;
...
{
    public partial class ForumController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult CreateForumGroup(ForumGroupModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Forums.ForumGroup.Added"));
        ...
        public virtual IActionResult CreateForum(ForumModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Forums.Forum.Added"));
        ...
        public virtual IActionResult EditForumGroup(ForumGroupModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Forums.ForumGroup.Updated"));
        ...
        public virtual IActionResult EditForum(ForumModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Forums.Forum.Updated"));
        ...
        public virtual IActionResult DeleteForumGroup(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Forums.ForumGroup.Deleted"));
            return RedirectToAction("List");
        }
        ...
        public virtual IActionResult DeleteForum(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Forums.Forum.Deleted"));
            return RedirectToAction("List");
        }
