...
{
    public partial class CurrencyController :  BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Create(CurrencyModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Currencies.Added"));
        ...
        public virtual IActionResult Edit(CurrencyModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (allCurrencies.Count == 1 && allCurrencies[0].Id == currency.Id &&
                    !model.Published)
                {
                    ErrorNotification(_localizationService.GetResource("Merchant.Configuration.Currencies.PublishedCurrencyRequired"));
                    return RedirectToAction("Edit", new { id = currency.Id });
                }
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Currencies.Updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            try
            {
                if (currency.Id == _currencySettings.PrimaryStoreCurrencyId)
                    throw new NopException(_localizationService.GetResource("Merchant.Configuration.Currencies.CantDeletePrimary"));

                if (currency.Id == _currencySettings.PrimaryExchangeRateCurrencyId)
                    throw new NopException(_localizationService.GetResource("Merchant.Configuration.Currencies.CantDeleteExchange"));
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Currencies.Deleted"));
                return RedirectToAction("List");
            }
            catch (Exception exc)
            {
