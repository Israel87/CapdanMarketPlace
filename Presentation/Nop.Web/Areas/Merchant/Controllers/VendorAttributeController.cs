...
{
    public partial class VendorAttributeController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Create(VendorAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Vendors.VendorAttributes.Added"));
        ...
        public virtual IActionResult Edit(VendorAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Vendors.VendorAttributes.Updated"));
                if (continueEditing)
                {
                    //selected tab
                    SaveSelectedTabName();
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Vendors.VendorAttributes.Deleted"));
            return RedirectToAction("List");
        }
