...
{
    public partial class ManufacturerController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Create(ManufacturerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Manufacturers.Added"));
        ...
        public virtual IActionResult Edit(ManufacturerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Manufacturers.Updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Manufacturers.Deleted"));
            return RedirectToAction("List");
        }
        ...
        public virtual IActionResult ImportFromXlsx(IFormFile importexcelfile)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Manufacturers.Imported"));
                return RedirectToAction("List");
            }
            catch (Exception exc)
            {
