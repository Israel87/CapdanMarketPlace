...
{
    public partial class TopicController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Create(TopicModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Topics.Added"));
        ...
        public virtual IActionResult Edit(TopicModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Topics.Updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Topics.Deleted"));
