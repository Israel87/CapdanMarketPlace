...
{
    public partial class OnlineCustomerController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult List(DataSourceRequest command)
        {
            ...
            var gridModel = new DataSourceResult
            {
                ...
                {
                    Id = x.Id,
                    CustomerInfo = x.IsRegistered() ? x.Email : _localizationService.GetResource("Merchant.Customers.Guest"),
                    LastIpAddress = _customerSettings.StoreIpAddresses ?
                        x.LastIpAddress :
                        _localizationService.GetResource("Merchant.Customers.OnlineCustomers.Fields.IPAddress.Disabled"),
                    ...
                    LastVisitedPage = _customerSettings.StoreLastVisitedPage ?
                        ...
                        _localizationService.GetResource("Merchant.Customers.OnlineCustomers.Fields.LastVisitedPage.Disabled")
                }),
