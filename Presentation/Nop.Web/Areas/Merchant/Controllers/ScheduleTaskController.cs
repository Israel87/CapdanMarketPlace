...
{
    public partial class ScheduleTaskController : BaseMerchantController
	{
		#region Fields
        ...
        public virtual IActionResult RunNow(int id)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.System.ScheduleTasks.RunNow.Done"));
            }
            catch (Exception exc)
            {
