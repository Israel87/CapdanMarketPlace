...
using Nop.Web.Areas.Merchant.Extensions;
using Nop.Web.Areas.Merchant.Helpers;
using Nop.Web.Areas.Merchant.Infrastructure.Cache;
...
namespace Nop.Web.Areas.Merchant.Controllers
{
    public partial class ProductController : BaseMerchantController
    {
        #region Fields
            ...
            Product product, ProductAttributeCombination combination = null)
        {
            ...
            if (combination != null)
            {
                ...
                model.NotifyMerchantForQuantityBelow = combination.NotifyAdminForQuantityBelow;
            ...
            model.NotifyMerchantForQuantityBelow = 1;
        ...
        protected virtual void PrepareProductModel(ProductModel model, Product product, bool setPredefinedValues, bool excludeProperties)
        {
            ...
            if (product != null)
            {
                ...
                model.CopyProductModel.Name = string.Format(_localizationService.GetResource("Merchant.Catalog.Products.Copy.Name.New"), product.Name);
            ...
            {
                Text = _localizationService.GetResource("Merchant.Catalog.Products.Fields.Vendor.None"),
                Value = "0"
            });
            ...
            {
                Text = _localizationService.GetResource("Merchant.Catalog.Products.Fields.DeliveryDate.None"),
                Value = "0"
            });
            ...
            {
                Text = _localizationService.GetResource("Merchant.Catalog.Products.Fields.ProductAvailabilityRange.None"),
                Value = "0"
            });
            ...
            {
                Text = _localizationService.GetResource("Merchant.Catalog.Products.Fields.Warehouse.None"),
                Value = "0"
            });
            ...
            model.AvailableTaxCategories.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Configuration.Settings.Tax.TaxCategories.None"), Value = "0" });
        ...
        protected virtual void SaveProductWarehouseInventory(Product product, ProductModel model)
        {
            ...
            foreach (var warehouse in warehouses)
            {
                ...
                var message = $"{_localizationService.GetResource("Merchant.StockQuantityHistory.Messages.MultipleWarehouses")} {_localizationService.GetResource("Merchant.StockQuantityHistory.Messages.Edit")}";
            ...
            if (pam.ValidationRulesAllowed())
            {
                ...
                if (pam.ValidationMinLength != null)
                    validationRules.AppendFormat("{0}: {1}<br />",
                        _localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.ValidationRules.MinLength"),
                        pam.ValidationMinLength);
                if (pam.ValidationMaxLength != null)
                    validationRules.AppendFormat("{0}: {1}<br />",
                        _localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.ValidationRules.MaxLength"),
                        pam.ValidationMaxLength);
                if (!string.IsNullOrEmpty(pam.ValidationFileAllowedExtensions))
                    validationRules.AppendFormat("{0}: {1}<br />",
                        _localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.ValidationRules.FileAllowedExtensions"),
                        WebUtility.HtmlEncode(pam.ValidationFileAllowedExtensions));
                if (pam.ValidationFileMaximumSize != null)
                    validationRules.AppendFormat("{0}: {1}<br />",
                        _localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.ValidationRules.FileMaximumSize"),
                        pam.ValidationFileMaximumSize);
                if (!string.IsNullOrEmpty(pam.DefaultValue))
                    validationRules.AppendFormat("{0}: {1}<br />",
                        _localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.ValidationRules.DefaultValue"),
        ...
        public virtual IActionResult List()
        {
            ...
            //categories
            model.AvailableCategories.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "0" });
            var categories = SelectListHelper.GetCategoryList(_categoryService, _cacheManager, true);
            foreach (var c in categories)
                model.AvailableCategories.Add(c);

            //manufacturers
            model.AvailableManufacturers.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "0" });
            var manufacturers = SelectListHelper.GetManufacturerList(_manufacturerService, _cacheManager, true);
            foreach (var m in manufacturers)
                model.AvailableManufacturers.Add(m);

            //stores
            model.AvailableStores.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "0" });
            foreach (var s in _storeService.GetAllStores())
                model.AvailableStores.Add(new SelectListItem { Text = s.Name, Value = s.Id.ToString() });

            //warehouses
            model.AvailableWarehouses.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "0" });
            ...
            //vendors
            model.AvailableVendors.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "0" });
            var vendors = SelectListHelper.GetVendorList(_vendorService, _cacheManager, true);
            foreach (var v in vendors)
                model.AvailableVendors.Add(v);
            ...
            model.AvailableProductTypes.Insert(0, new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "0" });

            //"published" property
            //0 - all (according to "ShowHidden" parameter)
            //1 - published only
            //2 - unpublished only
            model.AvailablePublishedOptions.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Catalog.Products.List.SearchPublished.All"), Value = "0" });
            model.AvailablePublishedOptions.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Catalog.Products.List.SearchPublished.PublishedOnly"), Value = "1" });
            model.AvailablePublishedOptions.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Catalog.Products.List.SearchPublished.UnpublishedOnly"), Value = "2" });
        ...
        public virtual IActionResult Create()
        {
            ...
            {
                ErrorNotification(string.Format(_localizationService.GetResource("Merchant.Catalog.Products.ExceededMaximumNumber"), _vendorSettings.MaximumProductNumber));
                return RedirectToAction("List");
            }
        ...
        public virtual IActionResult Create(ProductModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _productService.AddStockQuantityHistoryEntry(product, product.StockQuantity, product.StockQuantity, product.WarehouseId,
                    _localizationService.GetResource("Merchant.StockQuantityHistory.Messages.Edit"));
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Products.Added"));
        ...
        public virtual IActionResult Edit(ProductModel model, bool continueEditing)
        {
            ...
            {
                ErrorNotification(_localizationService.GetResource("Merchant.Catalog.Products.Fields.StockQuantity.ChangedWarning"));
                return RedirectToAction("Edit", new { id = product.Id });
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (previousWarehouseId != product.WarehouseId)
                {
                    ...
                    if (previousWarehouseId > 0)
                    {
                        ...
                        if (oldWarehouse != null)
                            oldWarehouseMessage = string.Format(_localizationService.GetResource("Merchant.StockQuantityHistory.Messages.EditWarehouse.Old"), oldWarehouse.Name);
                    }
                    ...
                    if (product.WarehouseId > 0)
                    {
                        ...
                        if (newWarehouse != null)
                            newWarehouseMessage = string.Format(_localizationService.GetResource("Merchant.StockQuantityHistory.Messages.EditWarehouse.New"), newWarehouse.Name);
                    }
                    var message = string.Format(_localizationService.GetResource("Merchant.StockQuantityHistory.Messages.EditWarehouse"), oldWarehouseMessage, newWarehouseMessage);
                ...
                else
                {
                    _productService.AddStockQuantityHistoryEntry(product, product.StockQuantity - previousStockQuantity, product.StockQuantity,
                        product.WarehouseId, _localizationService.GetResource("Merchant.StockQuantityHistory.Messages.Edit"));
                }
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Products.Updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Products.Deleted"));
            return RedirectToAction("List");
        }
        ...
        public virtual IActionResult CopyProduct(ProductModel model)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Products.Copied"));
        ...
        public virtual IActionResult SkuReservedWarning(int productId, string sku)
        {
            ...
            if (productBySku != null)
            {
                ...
                {
                    var message = string.Format(_localizationService.GetResource("Merchant.Catalog.Products.Fields.Sku.Reserved"), productBySku.Name);
            ...
            else
            {
                ...
                {
                    var message = string.Format(_localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.AttributeCombinations.Fields.Sku.Reserved"), 
        ...
        public virtual IActionResult ImportExcel(IFormFile importexcelfile)
        {
            ...
            try
            {
                ...
                {
                    ErrorNotification(_localizationService.GetResource("Merchant.Common.UploadFile"));
                    return RedirectToAction("List");
                }

                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Products.Imported"));
                return RedirectToAction("List");
            }
            catch (Exception exc)
            {
        ...
        public virtual IActionResult LowStockReport()
        {
            ...
            var allText = _localizationService.GetResource("Merchant.Catalog.LowStockReport.SearchPublished.All");
            model.AvailablePublishedOptions.Add(new SelectListItem { Text = allText, Value = "0" });
            var publishedOnlyText = _localizationService.GetResource("Merchant.Catalog.LowStockReport.SearchPublished.PublishedOnly");
            model.AvailablePublishedOptions.Add(new SelectListItem { Text = publishedOnlyText, Value = "1" });
            var unpublishedOnlyText = _localizationService.GetResource("Merchant.Catalog.LowStockReport.SearchPublished.UnpublishedOnly");
        ...
        public virtual IActionResult TierPriceList(DataSourceRequest command, int productId)
        {
            ...
            var tierPricesModel = product.TierPrices.OrderBy(x => x.StoreId).ThenBy(x => x.Quantity).ThenBy(x => x.CustomerRoleId).Select(x =>
            {
                ...
                if (x.StoreId > 0)
                {
                    ...
                    storeName = _localizationService.GetResource("Merchant.Catalog.Products.TierPrices.Fields.Store.All");
                ...
                return new ProductModel.TierPriceModel
                {
                    ...
                    StoreId = x.StoreId,
                    Store = storeName,
                    CustomerRole = x.CustomerRoleId.HasValue ? _customerService.GetCustomerRoleById(x.CustomerRoleId.Value).Name : _localizationService.GetResource("Merchant.Catalog.Products.TierPrices.Fields.CustomerRole.All"),
                    ProductId = x.ProductId,
        ...
        public virtual IActionResult TierPriceCreatePopup()
        {
            ...
            //customer roles
            model.AvailableCustomerRoles.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "0" });
        ...
        public virtual IActionResult ProductAttributeMappingCreate(ProductModel.ProductAttributeMappingModel model, bool continueEditing)
        {
            ...
            {
                //redisplay form
                ErrorNotification(_localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.AlreadyExists"));
                //model
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.Added"));
        ...
        public virtual IActionResult ProductAttributeMappingEdit(ProductModel.ProductAttributeMappingModel model, bool continueEditing)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.Updated"));
            if (continueEditing)
            {
                //selected tab
                SaveSelectedTabName();
        ...
        public virtual IActionResult ProductAttributeMappingDelete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.Deleted"));
            SaveSelectedTabName("tab-product-attributes");
            ...
            if (associatedProduct != null)
            {
                ...
                if (associatedProduct.ProductAttributeMappings.Any())
                {
                    if (associatedProduct.ProductAttributeMappings.Any(attribute => attribute.IsRequired))
                        return Json(new { Result = _localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.Values.Fields.AssociatedProduct.HasRequiredAttributes") });

                    return Json(new { Result = _localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.Values.Fields.AssociatedProduct.HasAttributes") });
                }
                
                //gift card
                if (associatedProduct.IsGiftCard)
                {
                    return Json(new { Result = _localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.Values.Fields.AssociatedProduct.GiftCard") });
                }

                //downloaable product
                if (associatedProduct.IsDownload)
                {
                    return Json(new { Result = _localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.Attributes.Values.Fields.AssociatedProduct.Downloadable") });
                }
            }
        ...
        public virtual IActionResult ProductAttributeCombinationList(DataSourceRequest command, int productId)
        {
            ...
            var combinationsModel = combinations.Select(combination =>
            {
                ...
                return new ProductAttributeCombinationModel
                {
                    ...
                    NotifyMerchantForQuantityBelow = combination.NotifyAdminForQuantityBelow,
        ...
        public virtual IActionResult ProductAttributeCombinationCreatePopup(int productId, ProductAttributeCombinationModel model)
        {
            ...
            var existingCombination = _productAttributeParser.FindProductAttributeCombination(product, attributesXml);
            if (existingCombination != null)
                warnings.Add(_localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.AttributeCombinations.AlreadyExists"));
            ...
            if (!warnings.Any())
            {
                ...
                var combination = new ProductAttributeCombination
                {
                    ...
                    NotifyAdminForQuantityBelow = model.NotifyMerchantForQuantityBelow,
                    PictureId = model.PictureId
                };
                _productAttributeService.InsertProductAttributeCombination(combination);
                ...
                _productService.AddStockQuantityHistoryEntry(product, combination.StockQuantity, combination.StockQuantity,
                    message: _localizationService.GetResource("Merchant.StockQuantityHistory.Messages.Combination.Edit"), combinationId: combination.Id);
        ...
        public virtual IActionResult ProductAttributeCombinationGeneratePopup(IFormCollection form, ProductAttributeCombinationModel model)
        {
            ...
            if (requiredAttributeNames.Any())
            {
                ...
                model.Warnings.Add(string.Format(_localizationService.GetResource("Merchant.Catalog.Products.ProductAttributes.AttributeCombinations.SelectRequiredAttributes"), string.Join(", ", requiredAttributeNames)));
        ...
        public virtual IActionResult ProductAttributeCombinationEditPopup(ProductAttributeCombinationModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                combination.NotifyAdminForQuantityBelow = model.NotifyMerchantForQuantityBelow;
        ...
        public virtual IActionResult StockQuantityHistory(DataSourceRequest command, int productId, int warehouseId)
        {
            ...
            var gridModel = new DataSourceResult
            {
                ...
                {
                    var warehouseName = _localizationService.GetResource("Merchant.Catalog.Products.Fields.Warehouse.None");
