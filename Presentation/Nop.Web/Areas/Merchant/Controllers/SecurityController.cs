...
using Nop.Web.Areas.Merchant.Models.Security;
using Nop.Core;
...
{
    public partial class SecurityController : BaseMerchantController
	{
		#region Fields
        ...
        public virtual IActionResult PermissionsSave(IFormCollection form)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.ACL.Updated"));
