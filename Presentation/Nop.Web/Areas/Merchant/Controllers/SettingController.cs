...
{
    public partial class SettingController : BaseMerchantController
	{
		#region Fields
        ...
        public virtual IActionResult ChangeStoreScopeConfiguration(int storeid, string returnUrl = "")
        {
            ...
            if (store != null || storeid == 0)
            {
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    SystemCustomerAttributeNames.MerchantAreaStoreScopeConfiguration, storeid);
            }

            //home page
            if (string.IsNullOrEmpty(returnUrl))
                returnUrl = Url.Action("Index", "Home", new { area = AreaNames.Merchant });
            //prevent open redirection attack
            if (!Url.IsLocalUrl(returnUrl))
                return RedirectToAction("Index", "Home", new { area = AreaNames.Merchant });
        ...
        public virtual IActionResult Blog(BlogSettingsModel model)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Updated"));
        ...
        public virtual IActionResult Shipping()
        {
            ...
            model.ShippingOriginAddress.AvailableCountries.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Address.SelectCountry"), Value = "0" });
            ...
            if (states.Any())
            {
                ...
                model.ShippingOriginAddress.AvailableStates.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Address.OtherNonUS"), Value = "0" });
        ...
        public virtual IActionResult Tax()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.EuVatEmailMerchantWhenNewVatSubmitted_OverrideForStore = _settingService.SettingExists(taxSettings, x => x.EuVatEmailAdminWhenNewVatSubmitted, storeScope);
            }
            ...
            model.TaxCategories.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Configuration.Settings.Tax.TaxCategories.None"), Value = "0" });
            ...
            //EU VAT countries
            model.EuVatShopCountries.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Address.SelectCountry"), Value = "0" });
            foreach (var c in _countryService.GetAllCountries(showHidden: true))
            ...
            model.DefaultTaxAddress.AvailableCountries.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Address.SelectCountry"), Value = "0" });
            foreach (var c in _countryService.GetAllCountries(showHidden: true))
            ...
            if (states.Any())
            {
                ...
                model.DefaultTaxAddress.AvailableStates.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Address.OtherNonUS"), Value = "0" });
        ...
        public virtual IActionResult Tax(TaxSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(taxSettings, x => x.EuVatEmailAdminWhenNewVatSubmitted, model.EuVatEmailMerchantWhenNewVatSubmitted_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult Catalog()
        {
            ...
            {
                Text = _localizationService.GetResource("Merchant.Catalog.ViewMode.Grid"),
                Value = "grid"
            });
            model.AvailableViewModes.Add(new SelectListItem
            {
                Text = _localizationService.GetResource("Merchant.Catalog.ViewMode.List"),
                Value = "list"
            });
        ...
        public virtual IActionResult Order()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.AllowMerchantsToBuyCallForPriceProducts_OverrideForStore = _settingService.SettingExists(orderSettings, x => x.AllowAdminsToBuyCallForPriceProducts, storeScope);
            }
        ...
        public virtual IActionResult Order(OrderSettingsModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _settingService.SaveSettingOverridablePerStore(orderSettings, x => x.AllowAdminsToBuyCallForPriceProducts, model.AllowMerchantsToBuyCallForPriceProducts_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult ReturnRequestReasonCreate(ReturnRequestReasonModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Settings.Order.ReturnRequestReasons.Added"));
        ...
        public virtual IActionResult ReturnRequestReasonEdit(ReturnRequestReasonModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Settings.Order.ReturnRequestReasons.Updated"));
                if (continueEditing)
                {
                    //selected tab
                    SaveSelectedTabName();
        ...
        public virtual IActionResult ReturnRequestReasonDelete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Settings.Order.ReturnRequestReasons.Deleted"));
            return RedirectToAction("ReturnRequestReasonList");
        }
        ...
        public virtual IActionResult ReturnRequestActionCreate(ReturnRequestActionModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Settings.Order.ReturnRequestActions.Added"));
        ...
        public virtual IActionResult ReturnRequestActionEdit(ReturnRequestActionModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Settings.Order.ReturnRequestActions.Updated"));
                if (continueEditing)
                {
                    //selected tab
                    SaveSelectedTabName();
        ...
        public virtual IActionResult ReturnRequestActionDelete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Settings.Order.ReturnRequestActions.Deleted"));
            return RedirectToAction("ReturnRequestActionList");
        }
        ...
        public virtual IActionResult CustomerUser(CustomerUserSettingsModel model)
        {
            ...
            if (customerSettings.UsernameValidationEnabled && customerSettings.UsernameValidationUseRegex)
            {
                ...
                catch (ArgumentException)
                {
                    ...
                    hasError = true;
                    ErrorNotification(_localizationService.GetResource("Merchant.Configuration.Settings.CustomerSettings.RegexValidationRule.Error"));
                }
            }
        ...
        public virtual IActionResult GeneralCommon()
        {
            ...
            //notify Merchant that CSS bundling is not allowed in virtual directories
            if (seoSettings.EnableCssBundling && this.HttpContext.Request.PathBase.HasValue)
                WarningNotification(_localizationService.GetResource("Merchant.Configuration.Settings.GeneralCommon.EnableCssBundling.Warning"), false);
            ...
            if (securitySettings.AdminAreaAllowedIpAddresses != null)
                ...
                {
                    model.SecuritySettings.MerchantAreaAllowedIpAddresses += securitySettings.AdminAreaAllowedIpAddresses[i];
                    if (i != securitySettings.AdminAreaAllowedIpAddresses.Count - 1)
                        model.SecuritySettings.MerchantAreaAllowedIpAddresses += ",";
                }
            model.SecuritySettings.ForceSslForAllPages = securitySettings.ForceSslForAllPages;
            model.SecuritySettings.EnableXsrfProtectionForMerchantArea = securitySettings.EnableXsrfProtectionForAdminArea;
            ...
            //Merchant area
            var MerchantAreaSettings = _settingService.LoadSetting<AdminAreaSettings>(storeScope);
            model.MerchantAreaSettings.UseRichEditorInMessageTemplates = MerchantAreaSettings.UseRichEditorInMessageTemplates;
            model.MerchantAreaSettings.UseRichEditorInMessageTemplates_OverrideForStore = _settingService.SettingExists(MerchantAreaSettings, x => x.UseRichEditorInMessageTemplates, storeScope);
        ...
        public virtual IActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            if (!string.IsNullOrEmpty(model.SecuritySettings.MerchantAreaAllowedIpAddresses))
                foreach (var s in model.SecuritySettings.MerchantAreaAllowedIpAddresses.Split(new [] { ',' }, StringSplitOptions.RemoveEmptyEntries))
                    if (!string.IsNullOrWhiteSpace(s))
                        securitySettings.AdminAreaAllowedIpAddresses.Add(s.Trim());
            securitySettings.ForceSslForAllPages = model.SecuritySettings.ForceSslForAllPages;
            securitySettings.EnableXsrfProtectionForAdminArea = model.SecuritySettings.EnableXsrfProtectionForMerchantArea;
                ...
                (string.IsNullOrWhiteSpace(captchaSettings.ReCaptchaPublicKey) || string.IsNullOrWhiteSpace(captchaSettings.ReCaptchaPrivateKey)))
            {
                ...
                ErrorNotification(_localizationService.GetResource("Merchant.Configuration.Settings.GeneralCommon.CaptchaAppropriateKeysNotEnteredError"));
            }
            ...
            * and loaded from database after each update */
             ...
             * This behavior can increase performance because cached settings will not be cleared 
             * and loaded from database after each update */
            MerchantAreaSettings.UseRichEditorInMessageTemplates = model.MerchantAreaSettings.UseRichEditorInMessageTemplates;

            _settingService.SaveSettingOverridablePerStore(MerchantAreaSettings, x => x.UseRichEditorInMessageTemplates, model.MerchantAreaSettings.UseRichEditorInMessageTemplates_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult ChangeEncryptionKey(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(newEncryptionPrivateKey) || newEncryptionPrivateKey.Length != 16)
                    throw new NopException(_localizationService.GetResource("Merchant.Configuration.Settings.GeneralCommon.EncryptionKey.TooShort"));

                var oldEncryptionPrivateKey = securitySettings.EncryptionKey;
                if (oldEncryptionPrivateKey == newEncryptionPrivateKey)
                    throw new NopException(_localizationService.GetResource("Merchant.Configuration.Settings.GeneralCommon.EncryptionKey.TheSame"));
                ...
                _settingService.SaveSetting(securitySettings);
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Settings.GeneralCommon.EncryptionKey.Changed"));
            }
            catch (Exception exc)
            {
        ...
        public virtual IActionResult ToggleFullText(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                if (! _fulltextService.IsFullTextSupported())
                    throw new NopException(_localizationService.GetResource("Merchant.Configuration.Settings.GeneralCommon.FullTextSettings.NotSupported"));
                ...
                if (commonSettings.UseFullTextSearch)
                {
                    ...
                    SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Settings.GeneralCommon.FullTextSettings.Disabled"));
                }
                else
                {
                    ...
                    SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Settings.GeneralCommon.FullTextSettings.Enabled"));
                }
            }
            catch (Exception exc)
            {
                ...
                .Select(x =>
                {
                    ...
                    if (x.StoreId == 0)
                    {
                        storeName = _localizationService.GetResource(
                            "Merchant.Configuration.Settings.AllSettings.Fields.StoreName.AllStores");
                    }
                    else
                    {
            ...
            if (_config.RedisCachingEnabled && loadAllLocaleRecordsOnStartup)
                return Json(new
                {
                    Result = _localizationService.GetResource(
                        "Merchant.Configuration.Settings.GeneralCommon.LoadAllLocaleRecordsOnStartup.Warning")
                });
