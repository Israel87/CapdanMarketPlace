...
{
    public partial class CategoryController : BaseMerchantController
    {
        #region Fields
        ...
        protected virtual void PrepareAllCategoriesModel(CategoryModel model)
        {
            ...
            {
                Text = _localizationService.GetResource("Merchant.Catalog.Categories.Fields.Parent.None"),
                Value = "0"
            });
        ...
        public virtual IActionResult Create(CategoryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Categories.Added"));
        ...
        public virtual IActionResult Edit(CategoryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Categories.Updated"));
                if (continueEditing)
                {
                    //selected tab
                    SaveSelectedTabName();
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Categories.Deleted"));
            return RedirectToAction("List");
        }
        ...
        public virtual IActionResult ImportFromXlsx(IFormFile importexcelfile)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Categories.Imported"));
                return RedirectToAction("List");
            }
            catch (Exception exc)
            {
