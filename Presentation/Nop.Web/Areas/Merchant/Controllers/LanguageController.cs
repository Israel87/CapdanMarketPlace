...
{
    public partial class LanguageController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Create(LanguageModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Languages.Added"));
        ...
        public virtual IActionResult Edit(LanguageModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (allLanguages.Count == 1 && allLanguages[0].Id == language.Id &&
                    !model.Published)
                {
                    ErrorNotification(_localizationService.GetResource("Merchant.Configuration.Languages.PublishedLanguageRequired"));
                    return RedirectToAction("Edit", new { id = language.Id });
                }
                ...
                //notification
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Languages.Updated"));
                if (continueEditing)
                {
                    //selected tab
                    SaveSelectedTabName();
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            //notification
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Languages.Deleted"));
            return RedirectToAction("List");
        }
        ...
        public virtual IActionResult ResourceUpdate(LanguageResourceModel model)
        {
            ...
            if (!resource.ResourceName.Equals(model.Name, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    return Json(new DataSourceResult { Errors = string.Format(_localizationService.GetResource("Merchant.Configuration.Languages.Resources.NameAlreadyExists"), res.ResourceName) });
                }
            }
        ...
        public virtual IActionResult ResourceAdd(int languageId,LanguageResourceModel model)
        {
            ...
            {
                return Json(new DataSourceResult { Errors = string.Format(_localizationService.GetResource("Merchant.Configuration.Languages.Resources.NameAlreadyExists"), model.Name) });
            }
        ...
        public virtual IActionResult ImportXml(int id, IFormFile importxmlfile)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Languages.Imported"));
                return RedirectToAction("Edit", new { id = language.Id });
            }
            catch (Exception exc)
            {
