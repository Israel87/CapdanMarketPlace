...
{
    public partial class CountryController : BaseMerchantController
	{
		#region Fields
        ...
        public virtual IActionResult Create(CountryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Countries.Added"));
        ...
        public virtual IActionResult Edit(CountryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Countries.Updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Countries.Deleted"));
                return RedirectToAction("List");
            }
            catch (Exception exc)
            {
        ...
        public virtual IActionResult StateDelete(int id)
        {
            ...
            {
                return Json(new DataSourceResult { Errors = _localizationService.GetResource("Merchant.Configuration.Countries.States.CantDeleteWithAddresses") });
            }
            ...
            bool? addSelectStateItem, bool? addAsterisk)
        {
            ...
            else
            {
                if (country == null)
                {
                    ...
                    {
                        result.Insert(0, new { id = 0, name = _localizationService.GetResource("Merchant.Address.SelectState") });
                    }
                    else
                    {
                        result.Insert(0, new { id = 0, name = _localizationService.GetResource("Merchant.Address.OtherNonUS") });
                    }
                }
                else
                {
        ...
        public virtual IActionResult ImportCsv(IFormFile importcsvfile)
        {
            ...
            try
            {
                if (importcsvfile != null && importcsvfile.Length > 0)
                {
                    ...
                    SuccessNotification(string.Format(_localizationService.GetResource("Merchant.Configuration.Countries.ImportSuccess"), count));
                    return RedirectToAction("List");
                }
