...
{
    public partial class ActivityLogController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult SaveTypes(IFormCollection form)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.ActivityLog.ActivityLogType.Updated"));
