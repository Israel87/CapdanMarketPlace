...
{
    public partial class RecurringPaymentController : BaseMerchantController
    {
        #region Fields
            ...
            RecurringPayment recurringPayment)
        {
            ...
            model.CustomerEmail = customer.IsRegistered() ? customer.Email : _localizationService.GetResource("Merchant.Customers.Guest");
        ...
        public virtual IActionResult Edit(RecurringPaymentModel model, bool continueEditing)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.RecurringPayments.Updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.RecurringPayments.Deleted"));
            return RedirectToAction("List");
        }
        ...
        public virtual IActionResult ProcessNextPayment(int id)
        {
            ...
            try
            {
                ...
                if (errors.Any())
                    ...
                    SuccessNotification(_localizationService.GetResource("Merchant.RecurringPayments.NextPaymentProcessed"), false);
        ...
        public virtual IActionResult CancelRecurringPayment(int id)
        {
            ...
            try
            {
                ...
                if (errors.Any())
                {
                    ...
                    SuccessNotification(_localizationService.GetResource("Merchant.RecurringPayments.Cancelled"), false);
