...
{
    public partial class VendorController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Create(VendorModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Vendors.Added"));
        ...
        public virtual IActionResult Edit(VendorModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Vendors.Updated"));
                if (continueEditing)
                {
                    //selected tab
                    SaveSelectedTabName();
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Vendors.Deleted"));
            return RedirectToAction("List");
        }
