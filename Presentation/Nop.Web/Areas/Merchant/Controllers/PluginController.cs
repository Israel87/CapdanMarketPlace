...
{
    public partial class PluginController : BaseMerchantController
	{
		#region Fields
        ...
        public virtual IActionResult List()
        {
            ...
            //groups
            model.AvailableGroups.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "" });
	    ...
	    public virtual IActionResult UploadPluginsAndThemes(IFormFile archivefile)
	    {
	        ...
	        try
	        {
                ...
                var message = string.Format(_localizationService.GetResource("Merchant.Configuration.Plugins.Uploaded"), pluginDescriptors.Count, themeDescriptors.Count);
        ...
        public virtual IActionResult Install(IFormCollection form)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Plugins.Installed"));
        ...
        public virtual IActionResult Uninstall(IFormCollection form)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Plugins.Uninstalled"));
	    ...
	    public virtual IActionResult Delete(IFormCollection form)
	    {
	        ...
	        try
	        {
	            ...
	            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Plugins.Deleted"));
        ...
        public virtual IActionResult OfficialFeed()
        {
            ...
            //versions
            model.AvailableVersions.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "0" });
            ...
            //prices
            model.AvailablePrices.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Common.All"), Value = "0" });
            model.AvailablePrices.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Configuration.Plugins.OfficialFeed.Price.Free"), Value = "10" });
            model.AvailablePrices.Add(new SelectListItem { Text = _localizationService.GetResource("Merchant.Configuration.Plugins.OfficialFeed.Price.Commercial"), Value = "20" });
            return View(model);
        }
