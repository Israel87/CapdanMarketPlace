...
{
    public partial class MeasureController : BaseMerchantController
	{
		#region Fields
        ...
        public virtual IActionResult WeightDelete(int id)
        {
            ...
            {
                return Json(new DataSourceResult { Errors = _localizationService.GetResource("Merchant.Configuration.Shipping.Measures.Weights.CantDeletePrimary") });
            }
        ...
        public virtual IActionResult DimensionDelete(int id)
        {
            ...
            {
                return Json(new DataSourceResult { Errors = _localizationService.GetResource("Merchant.Configuration.Shipping.Measures.Dimensions.CantDeletePrimary") });
            }
