...
{
    public partial class AddressAttributeController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Create(AddressAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Address.AddressAttributes.Added"));
        ...
        public virtual IActionResult Edit(AddressAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Address.AddressAttributes.Updated"));
                if (continueEditing)
                {
                    //selected tab
                    SaveSelectedTabName();
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Address.AddressAttributes.Deleted"));
            return RedirectToAction("List");
        }
