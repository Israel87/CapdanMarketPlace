...
{
    public partial class ShippingController : BaseMerchantController
	{
        #region Fields
        ...
        public virtual IActionResult CreateMethod(ShippingMethodModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.Methods.Added"));
        ...
        public virtual IActionResult EditMethod(ShippingMethodModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //locales
                UpdateLocales(sm, model);
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.Methods.Updated"));
        ...
        public virtual IActionResult DeleteMethod(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.Methods.Deleted"));
            return RedirectToAction("Methods");
        }
        ...
        public virtual IActionResult CreateDeliveryDate(DeliveryDateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.DeliveryDates.Added"));
        ...
        public virtual IActionResult EditDeliveryDate(DeliveryDateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.DeliveryDates.Updated"));
        ...
        public virtual IActionResult DeleteDeliveryDate(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.DeliveryDates.Deleted"));
        ...
        public virtual IActionResult CreateProductAvailabilityRange(ProductAvailabilityRangeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.ProductAvailabilityRanges.Added"));
        ...
        public virtual IActionResult EditProductAvailabilityRange(ProductAvailabilityRangeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.ProductAvailabilityRanges.Updated"));
        ...
        public virtual IActionResult DeleteProductAvailabilityRange(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.ProductAvailabilityRanges.Deleted"));
        ...
        public virtual IActionResult CreateWarehouse(WarehouseModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.Warehouses.Added"));
        ...
        public virtual IActionResult EditWarehouse(int id)
        {
            ...
            var model = new WarehouseModel
            {
                Id = warehouse.Id,
                Name = warehouse.Name,
                MerchantComment = warehouse.AdminComment
            };
        ...
        public virtual IActionResult EditWarehouse(WarehouseModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                warehouse.AdminComment = model.MerchantComment;
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.Warehouses.Updated"));
        ...
        public virtual IActionResult DeleteWarehouse(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.warehouses.Deleted"));
            return RedirectToAction("Warehouses");
        }
        ...
        public virtual IActionResult RestrictionSave(IFormCollection form)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.Shipping.Restrictions.Updated"));
