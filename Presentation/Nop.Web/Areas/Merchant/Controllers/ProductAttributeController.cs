...
{
    public partial class ProductAttributeController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult Create(ProductAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Attributes.ProductAttributes.Added"));
        ...
        public virtual IActionResult Edit(ProductAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Attributes.ProductAttributes.Updated"));
                if (continueEditing)
                {
                    //selected tab
                    SaveSelectedTabName();
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.Catalog.Attributes.ProductAttributes.Deleted"));
            return RedirectToAction("List");
        }
