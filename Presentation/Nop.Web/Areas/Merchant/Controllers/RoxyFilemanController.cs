...
namespace Nop.Web.Areas.Merchant.Controllers
{
    ...
    //[MerchantAntiForgery(true)]
    public class RoxyFilemanController : BaseMerchantController
    {
        #region Constants
        ...
        public virtual void CreateConfiguration()
        {
            ...
            var configuration = new
            {
                ...
                DIRLIST = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=DIRLIST",
                CREATEDIR = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=CREATEDIR",
                DELETEDIR = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=DELETEDIR",
                MOVEDIR = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=MOVEDIR",
                COPYDIR = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=COPYDIR",
                RENAMEDIR = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=RENAMEDIR",
                FILESLIST = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=FILESLIST",
                UPLOAD = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=UPLOAD",
                DOWNLOAD = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=DOWNLOAD",
                DOWNLOADDIR = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=DOWNLOADDIR",
                DELETEFILE = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=DELETEFILE",
                MOVEFILE = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=MOVEFILE",
                COPYFILE = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=COPYFILE",
                RENAMEFILE = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=RENAMEFILE",
                GENERATETHUMB = $"{this.HttpContext.Request.PathBase}/Merchant/RoxyFileman/ProcessRequest?a=GENERATETHUMB",
            };
