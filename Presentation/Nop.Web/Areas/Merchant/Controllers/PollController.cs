...
{
    public partial class PollController : BaseMerchantController
	{
        #region Fields
        ...
        public virtual IActionResult Create(PollModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Polls.Added"));
        ...
        public virtual IActionResult Edit(PollModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Polls.Updated"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.ContentManagement.Polls.Deleted"));
            return RedirectToAction("List");
        }
