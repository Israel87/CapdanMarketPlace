...
{
	public partial class QueuedEmailController : BaseMerchantController
	{
        ...
        public virtual IActionResult Edit(QueuedEmailModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.System.QueuedEmails.Updated"));
        ...
        public virtual IActionResult Requeue(QueuedEmailModel queuedEmailModel)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.System.QueuedEmails.Requeued"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.System.QueuedEmails.Deleted"));
			return RedirectToAction("List");
		}
        ...
        public virtual IActionResult DeleteAll()
        {
            ...
            SuccessNotification(_localizationService.GetResource("Merchant.System.QueuedEmails.DeletedAll"));
            return RedirectToAction("List");
        }
	}
}