...
{
	public partial class EmailAccountController : BaseMerchantController
	{
	    #region Fields
		...
		public virtual IActionResult Create(EmailAccountModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.EmailAccounts.Added"));
        ...
        public virtual IActionResult Edit(EmailAccountModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.EmailAccounts.Updated"));
                return continueEditing ? RedirectToAction("Edit", new { id = emailAccount.Id }) : RedirectToAction("List");
            }
        ...
        public virtual IActionResult ChangePassword(EmailAccountModel model)
        {
            ...
            emailAccount.Password = model.Password;
            _emailAccountService.UpdateEmailAccount(emailAccount);
            SuccessNotification(_localizationService.GetResource("Merchant.Configuration.EmailAccounts.Fields.Password.PasswordChanged"));
        ...
        public virtual IActionResult SendTestEmail(EmailAccountModel model)
        {
            ...
            try
            {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.EmailAccounts.SendTestEmail.Success"), false);
            }
            catch (Exception exc)
            {
	    ...
	    public virtual IActionResult Delete(int id)
	    {
	        ...
	        try
	        {
                ...
                SuccessNotification(_localizationService.GetResource("Merchant.Configuration.EmailAccounts.Deleted"));
