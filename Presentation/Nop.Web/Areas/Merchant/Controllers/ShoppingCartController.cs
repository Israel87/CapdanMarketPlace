...
{
    public partial class ShoppingCartController : BaseMerchantController
    {
        #region Fields
        ...
        public virtual IActionResult CurrentCarts(DataSourceRequest command, ShoppingCartTypeModel model)
        {
            ...
            var gridModel = new DataSourceResult
            {
                ...
                {
                    CustomerId = x.Id,
                    CustomerEmail = x.IsRegistered() ? x.Email : _localizationService.GetResource("Merchant.Customers.Guest"),
