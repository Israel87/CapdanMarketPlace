...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            //routeBuilder.MapLocalizedRoute("Merchant", 
            //  new {area = "Merchant", controller = "Home", action = "Index" });
            ...
            // Verification Of Things
            routeBuilder.MapLocalizedRoute("VerificationOfThings", "verificationofthings",
                new { controller = "VerificationOfThings", action = "VerificationOfThings" });
            ...
            // VOT(Verification of things) view
            routeBuilder.MapLocalizedRoute("VOT", "",
               new { controller = "VOT", action = "VOT" });

            // Chams Switch Payment Interface 
            routeBuilder.MapLocalizedRoute("ChamsSwitchInterface", "chamsswitchinterface", 
                new { controller = "Checkout", action = "ChamsSwitchInterface" });
        }
