...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        //CustomerMerchant GetCustomerMerchantById(int customerId);
        /// <summary>
        ...
        /// </summary>
        /// <param name="civn">Customer identifier</param>
        /// <returns>Customer</returns>
        Customer GetMerchantCustomerByCIVN(string civn);
        ...
        /// </summary>
        /// <returns>Customer</returns>
        List<CustomerMerchant> GetAllMerchants();
