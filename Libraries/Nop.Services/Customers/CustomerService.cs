...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        public virtual IPagedList<Customer> GetAllCustomers(DateTime? createdFromUtc = null,
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false, string bvn = null)
        {
            var query = _customerRepository.Table;
            if (createdFromUtc.HasValue)
                query = query.Where(c => createdFromUtc.Value <= c.CreatedOnUtc);
        ...
        public virtual List<CustomerMerchant> GetAllMerchants()
        {
            //invoke stored procedure
            //var merchantlist = _dbContext.StoreprocedureQuery<Customer>("SpGetAllMerchant");
            return _dbContext.SqlQuery<CustomerMerchant>("EXEC SpGetAllMerchant").ToList();

        }

        public Customer GetMerchantCustomerByCIVN(string civn)
        {
            //GetMerchantCustomerByCIVN
            return _dbContext.SqlQuery<Customer>("EXEC GetMerchantCustomerByCIVN  @civn", new SqlParameter("civn", civn)).SingleOrDefault();
        }

        //List<Customer> ICustomerService.GetAllMerchants()
        //{
        //    throw new NotImplementedException();
        //}
        //public virtual List<Customer> GetCustomerss()
        //{
        //    //var query = _customerRepository.Table;
        //    //return query.ToList();
        //    // added by Sayo 
        ...
        //                where c.CustomerRoles.FirstOrDefault().Id == 6
        //                select c;
