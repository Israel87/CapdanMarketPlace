...
//        /// </param>
//        /// <returns>Products</returns>
//        IPagedList<Product> SearchAllProducts(
...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        /// <summary>
        /// Get all the products relating to a merchant
        /// </summary>
        /// <param name="customerID"></param>
        /// <returns></returns>
        IList<Product>  GetAllProductsByMerchantsAsCustomerID(int customerID);

        IList<Product> GetAllProductsByMerchantsByCIVN(string civn);
        /// <summary>
        /// Update HasTierPrices property (used for performance optimization)
        /// </summary>
        /// <param name="product">Product</param>
