...
//        /// 
//        protected virtual IPagedList<Product> SearchAllProductsUseLinq(ref IList<int> filterableSpecificationAttributeOptionIds,
...
//            IList<int> filteredSpecs, ProductSortingEnum orderBy, bool showHidden, bool? overridePublished, int? customerId)
//        {
//            //products
...
//            {
//                query = query.Where(p => p.CustomerId == customerId.GetValueOrDefault());
//            }
...
//        protected virtual IPagedList<Product> SearchAllProductsUseStoredProcedure(ref IList<int> filterableSpecificationAttributeOptionIds,
//            bool loadFilterableSpecificationAttributeOptionIds, int pageIndex, int pageSize, IList<int> categoryIds,
//            int manufacturerId, int storeId, int vendorId, int warehouseId, ProductType? productType,
//            bool visibleIndividuallyOnly, bool markedAsNewOnly, bool? featuredProducts, decimal? priceMin, decimal? priceMax,
//            int productTagId, string keywords, bool searchDescriptions, bool searchManufacturerPartNumber, bool searchSku,
...
//            pFilterableSpecificationAttributeOptionIds.Size = int.MaxValue - 1;
//            var pTotalRecords = _dataProvider.GetOutputInt32Parameter("TotalRecords");
//            var pCustomerId = _dataProvider.GetInt32Parameter("customerId", customerId.GetValueOrDefault());
//            //invoke stored procedure
//            var products = _dbContext.ExecuteStoredProcedureList<Product>(
//                "spProductLoadAllPaged",
//                pCategoryIds,
//                pManufacturerId,
//                pStoreId,
//                pVendorId,
...
//        public virtual IPagedList<Product> SearchAllProducts(
//      int pageIndex = 0,
...
//      int? customerId = 0)
//        {
//            return SearchAllProducts(out IList<int> _, false,
...
//                orderBy, showHidden, overridePublished, customerId);
//        }
...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        protected virtual IPagedList<Product> SearchProductsUseLinq(ref IList<int> filterableSpecificationAttributeOptionIds,
            ...
            int productTagId, string keywords, bool searchDescriptions, bool searchManufacturerPartNumber, bool searchSku,
            bool searchProductTags, bool searchLocalizedValue, int[] allowedCustomerRolesIds, int languageId,
            IList<int> filteredSpecs, ProductSortingEnum orderBy, bool showHidden, bool? overridePublished, int? customerId = 0)
        {
            //products
            var query = _productRepository.Table;
            query = query.Where(p => !p.Deleted);
            ...
            IList<int> filteredSpecs, ProductSortingEnum orderBy, bool showHidden, bool? overridePublished, int? CustomerId)
        {
            ...
            //Get product by cusotmerID added by AK
            var pCustomerId = _dataProvider.GetInt32Parameter("CustomerId", CustomerId);
            //prepare output parameters
            var pFilterableSpecificationAttributeOptionIds = _dataProvider.GetOutputStringParameter("FilterableSpecificationAttributeOptionIds");
            pFilterableSpecificationAttributeOptionIds.Size = int.MaxValue - 1;
            var pTotalRecords = _dataProvider.GetOutputInt32Parameter("TotalRecords");
        ...
        public IList<Product> GetAllProductsByMerchantsAsCustomerID(int customerID)
        {
           var products = _dbContext.SqlQuery<Product>("EXEC spGetAllProductsByCustomerID  @customerID", new SqlParameter("customerID", customerID)).ToList();
           return products;
        }


        public IList<Product> GetAllProductsByMerchantsByCIVN(string civn)
        {
            var products = _dbContext.SqlQuery<Product>("EXEC spGetAllProductsByCIVN  @civn", new SqlParameter("civn", civn)).ToList();
            return products;
        }
